...
map.getView().fit([3214115.866143, -1250456.705251, 3220841.524369, -1247579.541410], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Kasama_Project_Database</h2>';
        return titleElement;
    })(),
